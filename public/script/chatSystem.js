...
class ChatSystem {
    ...
    getResponseForMessage(message) {
        const responseMap = {
            ...
            'ติดต่อ': ['ท่านสามารถติดต่อเราได้ที่ โทร. 012-345-6789 หรือ Email: info@example-tambon.go.th ครับ'],
            'ขอข้อมูลติดต่อ': ['ข้อมูลติดต่อ: โทร. 012-345-6789, Email: info@example-tambon.go.th, ที่อยู่: 123 หมู่ 1 ตำบลตัวอย่าง ครับ'],
