...
router.post('/wasteSaleRequestApprove/:id', employeeController.wasteSaleRequestApprovePost);
...
router.get('/funeral-assistance/members/:familyID', employeeController.getFamilyMembers);
